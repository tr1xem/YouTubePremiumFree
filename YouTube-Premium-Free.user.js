...
(function() {
    ...
    */
    function removePlayerAD(id){
        ...
        const observer = new MutationObserver(()=>{getVideoDom();closeOverlay();});// Maneja anuncios de video relacionados
...
const i18n = {
        'is': {
            ...
            mistake: {
                ...
                addShortsButton: 'Error adding download button Shorts:'
            }
        }
    };
    ...
    function createDownloadButton() {
        ...
        downloadButton.textContent = i18n.is.downloadText;
